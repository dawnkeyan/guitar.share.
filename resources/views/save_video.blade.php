            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/save_video?id='.(isset($data->id)?$data->id : null)) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="file" class="col-md-4 control-label">视频</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="context" type="text" class="form-control" name="context" value="{{ (isset($data->context)?$data->context : null) }}">
                                </div>
                            </div>
